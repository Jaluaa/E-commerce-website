      ...
      <div className="mt-4 flex flex-col flex-grow">
        ...
        <div className="mt-4 flex items-center justify-between pt-3 border-t border-white/5">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-bold text-white shadow-lg transition-all duration-300 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-brand-primary to-brand-accent hover:brightness-115 shimmer-btn"
          >
