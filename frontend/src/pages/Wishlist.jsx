            ...
            {wishlistItems.map(product => (
              <div key={product.id} className="relative group">
                ...
                <button
                  ...
                  className="absolute bottom-20 left-4 right-4 z-10 py-2 rounded-xl bg-slate-950/80 border border-white/10 text-[10px] font-bold text-white text-center backdrop-blur-md opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 active:scale-95 transition-all duration-300 shimmer-btn cursor-pointer"
                >
